...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthEvent authEvent, String? response, UserModel? user});
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl({required this.authEvent, this.response, this.user});
  ...
  @override
  String toString() {
    return 'AuthState(authEvent: $authEvent, response: $response, user: $user)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, authEvent, response, user);
