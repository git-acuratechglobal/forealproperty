...
import 'sales_agency_agreement/widgets/gradient_progressbar.dart';

class ManageActivity extends StatefulWidget {
  const ManageActivity({super.key, required this.activityList});
...
class AgreementActivityTimeline extends StatelessWidget {
  final List<Activity> activities;
  const AgreementActivityTimeline({super.key, required this.activities});
                  ...
                  Expanded(
                    child: Padding(
                      padding: EdgeInsets.only(
                        bottom: i != activities.length - 1 ? 20.h : 0,
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          5.verticalSpace,
                          Text(
                            _formatDate(activities[i].activityDate),
                            style: fontStyle.bodyMedium?.copyWith(
                              color: const Color(0xFF164C63),
                            ),
                          ),
