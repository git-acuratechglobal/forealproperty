...
class SmokeAlarm extends ConsumerStatefulWidget {
  const SmokeAlarm({super.key, required this.utilitiesDetails, required this.inspectionId});
...
class _SmokeAlarmState extends ConsumerState<SmokeAlarm> {
  ...
  Widget build(BuildContext context) {
    ...
    final updateState=ref.watch(inspectionComplianceParamProvider);
    return PopScope(
                          ...
                          children: [
                            ...
                            DatePickerDropdown2(
                              validator: (value) {
                                ...
                                switch (index) {
                                  case 2:
                                    shouldValidate = updateState.SmokeAlarmWorking ?? false;
                                    break;
                                  case 4:
                                    shouldValidate = updateState.SmokeAlarmBttryReplaced ?? false;
                                    break;
                                  case 6:
                                    shouldValidate = updateState.HaveRemovableBattry ?? false;
                                    break;
                                }
