...
class _WtaerEfficiencyScreenState extends ConsumerState<WtaerEfficiencyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final updatedState = ref.watch(inspectionComplianceParamProvider);
    return PopScope(
                          ...
                          onChanged: (val) {
                            switch (index) {
                              ...
                              case 3:
                                params.update(
                                  (p) =>
                                      p.copyWith(ColdWatrTapsMaximumFlow: val),
                                );
                                break;
                              case 4:
                                params.update(
                              ...
                              DatePickerDropdown2(
                                  validator: (value) {
                                    ...
                                    switch (index) {
                                      case 6:
                                        shouldValidate =
                                            (updatedState.WaterMeterReading !=
                                                null);
                                        break;
                                      // case 8:
                                      //   shouldValidate = (updatedState
                                  ...
                                  onDateSelected: (date) {
                                    switch (index) {
                                      case 6:
                                        params.update((p) => p.copyWith(
                                            WaterEfficiencyDateChecked: date));
                                        break;
                                      case 7:
                                        params.update((p) => p.copyWith(
